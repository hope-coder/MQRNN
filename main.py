...
class MQRNN():
    ...
    def train(self, x_train_shuffle, x_train_hour_shuffle, y_train_shuffle, x_test_shuffle, x_test_hour_shuffle,
              y_test):
        self.model.fit([x_train_shuffle, x_train_hour_shuffle], y_train_shuffle,
                       validation_data=([x_test_shuffle, x_test_hour_shuffle], y_test))
...
if __name__ == '__main__':
    ...
    # np.savez("data.npz", x_train_shuffle=x_train_shuffle, x_train_hour_shuffle=x_train_hour_shuffle, y_train=y_train,
